...
public class ArchaeaController{
	...
	private final String IMG_DIR = "/guiImages/CellImages/Prokaryotes/Archaea/ArchaeaComponents/";
    @FXML
        ...
        if (s == "Album View"){
            try {
                ...
                albumController controller = new albumController(cells,components,
                		"/guiImages/CellImages/Prokaryotes/Archaea","Archaea");
    ...
    public ArchaeaController(ArrayList<Cell>cells,ArrayList<Component>components) {
    	this.cells = cells;
